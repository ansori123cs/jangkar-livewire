    ...
    <div class="flex flex-col-reverse lg:flex-row items-center justify-center h-screen">
        <div class="card sm:card-side grid lg:grid-cols-2 lg:max-w-4xl max-w-[335px] w-full">
            <div class="card-body justify-center">
                ...
                <span class="mb-2">
                    Seamlessly integrate <strong>FlyonUI</strong> components into your <strong>Laravel Livewire</strong>
                    projects. Kickstart development with pre-built UI elements and <strong>Headless JS</strong>
                    components. Explore our live documentation and demos for a detailed guide.
                </span>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center space-x-3">
                        ...
                        <span class="text-base-content">
                            Get started with FlyonUI Laravel <livewire:simple-link :link="'https://flyonui.com/framework-integrations/laravel/'"
            ...
            <figure>
                <img class="card-img card-img-right"
                    src="{{ asset('assets/img/illustrations/laravel-livewire-flyonui.png') }}"
                    alt="Laravel Livewire with FlyonUI">
            </figure>
        </div>
